...
![route missing error](routing-error-1.png)
...
![controller missing error](routing-error-2.png)
...
![template missing error](template-error.png)
...
![cheese html page](cheese-page-html.png)
...
![cheese json page](cheese-page-json.png)
